    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('sent', 'Подтвержден'), ('sent', 'Отправлен'), ('delivered', 'Доставлен'), ('rejected', 'Отменен')], default='new', max_length=9, verbose_name='Статус')),
